...
HD_PWD='D:/Vivado/repos/mulx4_2/mulx4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mutx4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mutx4_2.tcl
