...
HD_PWD='D:/Vivado/repos/mulx4_2/mulx4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mutx4_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mutx4_2.tcl -notrace
