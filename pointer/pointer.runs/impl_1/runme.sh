...
HD_PWD='D:/Vivado/repos/pointer/pointer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pointer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pointer.tcl -notrace
