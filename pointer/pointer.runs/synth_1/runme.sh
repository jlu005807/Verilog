...
HD_PWD='D:/Vivado/repos/pointer/pointer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pointer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pointer.tcl
