...
HD_PWD='D:/Vivado/repos/Inout_top/Inout_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inout_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inout_top.tcl
